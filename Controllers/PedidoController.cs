...
namespace SistemaFlavorsThatInspire.Controllers
{
    public class PedidoController : Controller
    {
        ...
        {
            var contexto = _context.Pedido.Include(p => p.Usuario);
        ...
        public async Task<IActionResult> Create([Bind("PedidoId,UsuarioId,PrecoPedido")] Pedido pedido)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public async Task<IActionResult> Edit(int id, [Bind("PedidoId,UsuarioId,PrecoPedido")] Pedido pedido)
        {
