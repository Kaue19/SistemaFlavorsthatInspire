        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    CategoriaId = table.Column<int>(type: "int", nullable: false),
                    ProdutoDesconto = table.Column<double>(type: "float", nullable: false)
                },
                constraints: table =>
                {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    PedidoId = table.Column<int>(type: "int", nullable: false)
                        .Annotation("SqlServer:Identity", "1, 1"),
                    UsuarioId = table.Column<int>(type: "int", nullable: false),
                    PrecoPedido = table.Column<double>(type: "float", nullable: false)
                },
                constraints: table =>
                {
            ...
            migrationBuilder.CreateTable(
                name: "StatusDaEntrega",
                columns: table => new
                {
                    StatusDaEntregaId = table.Column<int>(type: "int", nullable: false)
                        .Annotation("SqlServer:Identity", "1, 1"),
                    UsuarioId = table.Column<int>(type: "int", nullable: false),
                    PedidoId = table.Column<int>(type: "int", nullable: false),
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_StatusDaEntrega", x => x.StatusDaEntregaId);
                    table.ForeignKey(
                        name: "FK_StatusDaEntrega_Pedido_PedidoId",
                        column: x => x.PedidoId,
                        principalTable: "Pedido",
                        principalColumn: "PedidoId",
                        onDelete: ReferentialAction.Cascade);
                    table.ForeignKey(
                        name: "FK_StatusDaEntrega_Usuario_UsuarioId",
                        column: x => x.UsuarioId,
                        principalTable: "Usuario",
                        principalColumn: "UsuarioId");
                });
            ...
            migrationBuilder.CreateIndex(
                name: "IX_StatusDaEntrega_PedidoId",
                table: "StatusDaEntrega",
                column: "PedidoId");

            migrationBuilder.CreateIndex(
                name: "IX_StatusDaEntrega_UsuarioId",
                table: "StatusDaEntrega",
                column: "UsuarioId");
        }
